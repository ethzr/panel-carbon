        ...
        >
            <Form>
                <div className={'ptero-toolbar'} style={{ marginTop: 0, justifyContent: 'space-between' }}>
                    ...
                    <Button type={'submit'}>{subuser ? 'Save' : 'Invite User'}</Button>
                </div>
                ...
                <div className={'ptero-stack'} style={{ margin: '1.5rem 0' }}>
                    {Object.keys(permissions)
                        ...
                        .map((key) => (
                            ...
                            >
                                <p className={'ptero-muted'}>{permissions[key].description}</p>
